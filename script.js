...
var CLIENT_ID = '293966599384-1fs2u5n7elqod0burm3fp9mdv0hbg5il.apps.googleusercontent.com';
var API_KEY = 'AIzaSyDj3LB71-K1V3ehhmdKHfA_KTH8SkFfG8Q';
...
function upload(){
    ...
    // if (file) {
    //     const blob = new Blob([file.value], { type: 'image/jpeg' });
    //     // get parent folder id from localstorage
    //     const parentFolder = localStorage.getItem('parent_folder');
    //     var twoWords = text.value.split(' ')[0] + '-' + text.value.split(' ')[1];
    //     // set file metadata
